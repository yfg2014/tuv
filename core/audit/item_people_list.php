...
if ($xmonline != '' ) {$sql_temp = $sql_temp."and taskId in (SELECT id FROM `xm_task` WHERE `xmonline` ='{$xmonline}')";}
/*if($_SESSION['userid'] != 'q1')
{
	if(strpos($_SESSION['power'],'Z1S') === false){
