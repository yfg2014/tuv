...
GrepUtil::InitGP(array('zuzhi_id','taskId','htfrom','filekind','filegroup','other','username'));

$save_path = UPLOAD_DIR.$setup_uploadpath[2].$zuzhi_id.'/';
$upload_name = "Filedata";
$max_file_size_in_bytes = 1024100000;
$extension_whitelist = array("jpg", "gif", "png","pdf","rar","zip","doc","docx","xls","doc","txt","ppt");
...
if (!@move_uploaded_file($_FILES[$upload_name]["tmp_name"], $save_path.$filename)) {
	...
	DBUtil::insert_tb($db, $dbtable['xm_task_file'], $value);
}
