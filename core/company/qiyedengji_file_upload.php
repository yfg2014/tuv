...
GrepUtil::InitGP(array('zuzhi_id','htfrom','filekind','filegroup','other','username'));

$save_path = UPLOAD_DIR.$setup_uploadpath[0].'/'.$zuzhi_id.'/';
...
if (!@move_uploaded_file($_FILES[$upload_name]["tmp_name"], $save_path.$filename)) {
	...
	DBUtil::insert_tb($db, $dbtable['mk_company_file'], $value);
}
