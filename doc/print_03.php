...
$w['eilinkman_mob'] = $com['eilinkman_mob'];            //联系人mob
...
$localh = 'http://'.$_SERVER['HTTP_HOST'].'/tuv/doc/doc/files/print_03.htm';
$localx = 'http://'.$_SERVER['HTTP_HOST'].'/tuv/doc/doc/files/print_03.xml';

foreach($w as $k=>$v){
	$w[$k] = iconv("utf-8","gbk//IGNORE",$v);
}

require "./doc/doc/print_03.doc";
