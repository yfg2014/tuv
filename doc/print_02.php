...
$localh = 'http://'.$_SERVER['HTTP_HOST'].'/tuv/doc/doc/files/print_02.htm';
$localx = 'http://'.$_SERVER['HTTP_HOST'].'/tuv/doc/doc/files/print_02.xml';

foreach($w as $k=>$v){
	$w[$k] = iconv("utf-8","gbk//IGNORE",$v);
}

require "./doc/doc/print_02.doc";
