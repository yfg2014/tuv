...
Calendar.prototype.callHandler = function () {
	if (this.onSelected) {
		this.onSelected(this, this.date.print(this.dateFormat)); //赋值给表单日期
	}
};
...
// tooltips
Calendar._TT = {};
Calendar._TT["TOGGLE"] = "控制星期首日";
Calendar._TT["PREV_YEAR"] = "上一年 (点击切换)";
Calendar._TT["PREV_MONTH"] = "上一月 (点击切换)";
Calendar._TT["GO_TODAY"] = "转到今天";
Calendar._TT["NEXT_MONTH"] = "下一月 (点击切换)";
Calendar._TT["NEXT_YEAR"] = "下一年 (点击转换)";
Calendar._TT["SEL_DATE"] = "选择日期";
Calendar._TT["DRAG_TO_MOVE"] = "拖动";
Calendar._TT["PART_TODAY"] = " (今天)";
Calendar._TT["MON_FIRST"] = "首先显示周一";
Calendar._TT["SUN_FIRST"] = "首先显示周日";
Calendar._TT["CLOSE"] = "关闭窗口";
